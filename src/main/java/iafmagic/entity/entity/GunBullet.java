...
public class GunBullet extends ThrownItemEntity {
  ...
  public GunBullet(EntityType<? extends ThrownItemEntity> entityType, World world) {
    super(entityType, world);
  }

  public GunBullet(World world, LivingEntity owner) {
    super(null, owner, world);
  }

  public GunBullet(World world, double x, double y, double z) {
