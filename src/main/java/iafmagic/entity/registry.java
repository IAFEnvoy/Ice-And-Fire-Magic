...
import iafmagic.entity.items.IceBallItem;
...
public class registry {
  public static final EntityType<FireBallEntity> FireBall = Registry.register(Registry.ENTITY_TYPE,
      ...
      FabricEntityTypeBuilder.<FireBallEntity>create(SpawnGroup.MISC, FireBallEntity::new)
          ...
          .trackRangeBlocks(4).trackedUpdateRate(10) // necessary for all thrown projectiles (as it prevents it from
                                                     // breaking, lol)
          .build() // VERY IMPORTANT DONT DELETE FOR THE LOVE OF GOD PSLSSSSSS
  );
  public static final Item fireball = new FireBallItem(new Item.Settings().maxDamage(200));

  public static final EntityType<IceBallEntity> IceBall = Registry.register(Registry.ENTITY_TYPE,
  ...
  public static final Item iceball = new IceBallItem(new Item.Settings().maxDamage(200));
